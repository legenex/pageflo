...
export const slots: LpSlot[] = [
  {
    ...
    "section": 1,
    "sectionLabel": "header",
    "default": "<div style=\"width:132px;height:32px;border:1.5px dashed var(--lp-n509, #bdbdbd);background:var(--lp-n886, #f2f2ef);border-radius:6px;display:flex;align-items:center;justify-content:center\"><span style=\"font-family:'JetBrains Mono',monospace;font-size:9px;color:var(--lp-n067, #494949);letter-spacing:.1em\">[LOGO SLOT]</span></div>",
    "required": false,
    "maxChars": 40,
    "pairedWith": "s01_image_src_1__alt",
    "assetKind": "logo",
    "well": {
      "openTag": "<div style=\"width:132px;height:32px;border:1.5px dashed var(--lp-n509, #bdbdbd);background:var(--lp-n886, #f2f2ef);border-radius:6px;display:flex;align-items:center;justify-content:center\">",
      "labelStyle": "font-family:'JetBrains Mono',monospace;font-size:9px;color:var(--lp-n067, #494949);letter-spacing:.1em",
      "surface": "var(--lp-n886, #f2f2ef)"
    }
  },
  {
  ...
  },
  {
    ...
    "assetKind": "logo",
    "well": {
      "openTag": "<div style=\"width:110px;height:26px;border:1.5px dashed var(--lp-n509, #bdbdbd);background:var(--lp-n928, #f7f7f4);border-radius:6px;display:flex;align-items:center;justify-content:center\">",
      "labelStyle": "font-family:'JetBrains Mono',monospace;font-size:8.5px;color:var(--lp-n067, #494949);letter-spacing:.1em",
      "surface": "var(--lp-n928, #f7f7f4)"
    }
  },
  {
...
export const quizMount: LpQuizMount = {
  ...
  "tag": "div",
  "openTag": "<div style=\"background:var(--lp-n1000, #ffffff);border:1px solid var(--lp-n728, #dededa);border-radius:10px;padding:22px clamp(16px,3vw,24px);box-shadow:0 10px 28px -16px rgba(31,31,31,.22)\">",
