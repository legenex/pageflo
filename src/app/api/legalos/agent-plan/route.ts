/**
 * Compatibility alias. The implementation lives at `/api/pageflo/agent-plan`.
 *
 ...
 *
 * This one in particular: the agent status reporters documented in
 * `AGENTS.md` POST here, and `/admin/plan` still polls it.
 *
 * Removing this file is safe only once those consumers call
 * `/api/pageflo/agent-plan` instead.
 */
...
export { GET, POST } from '../../pageflo/agent-plan/route'
