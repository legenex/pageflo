/**
 * Compatibility alias. The implementation lives at `/api/pageflo/quiz-webhook-test`.
 *
 ...
 * `/api/pageflo/quiz-webhook-test` instead.
 */
...
export { POST } from '../../pageflo/quiz-webhook-test/route'
