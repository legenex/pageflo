/**
 * Compatibility alias. The implementation lives at `/api/pageflo/quiz-ai`.
 *
 ...
 * pages call it, and those pages hold a cached bundle we cannot re-issue.
 *
 * Removing this file is safe only once those consumers call
 * `/api/pageflo/quiz-ai` instead.
 */
...
export { POST } from '../../pageflo/quiz-ai/route'
